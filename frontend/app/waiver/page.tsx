        ...
        <div className="min-h-screen bg-slate-50 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-xl overflow-hidden">
                <div className="bg-neon-blue px-8 py-6">
                    ...
                    <p className="text-slate-800 mt-1">Spin Pin</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="p-8 space-y-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="h-64 overflow-y-auto bg-slate-50 p-4 rounded-lg border text-sm text-slate-600">
                            ...
                            <p className="mb-2">In consideration of being permitted to participate in the activities at Spin Pin, I acknowledge and agree to the following:</p>
                            ...
                            <p className="mb-2">2. <strong>Release of Liability:</strong> I hereby release, waive, and discharge Spin Pin, its owners, employees, and agents from any and all liability for any loss, damage, injury, or expense that I may suffer as a result of my participation.</p>
                            ...
                            <p className="mb-2">4. <strong>Media Release:</strong> I grant permission for Spin Pin to use my likeness in photographs or video recordings for marketing purposes.</p>

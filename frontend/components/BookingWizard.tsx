        ...
        const loadConfigAndBlocks = async () => {
            ...
            try {
                ...
                setConfig({
                    ...
                    spectator_price: 295,
                    gst_rate: 0,
                    adult_label: "Adults (7+ Years)",
                    kid_label: "Kids (Under 7 Years)",
                    spectator_label: "Spectators (Age 4+)",
                    adult_description: "£9.95 per game/person",
                    kid_description: "£9.95 per game/person",
                    spectator_description: "£2.95 per person",
    ...
    if (bookingComplete) {
        return (
            ...
            >
                ...
                >
                    Thank you for booking with Spin Pin! Your tickets have been sent to {" "}
                                ...
                                >
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        >
                                            <div className="text-center md:text-left flex-1">
                                                <h3 className="text-xl font-bold text-white flex items-center gap-2">
                                                    {config?.adult_label || "Adults (7+ Years)"}
                                        ...
                                        >
                                            <div className="text-center md:text-left flex-1">
                                                <h3 className="text-xl font-bold text-white flex items-center gap-2">
                                                    {config?.kid_label || "Kids (Under 7 Years)"}
                                        ...
                                        <div className="border-t border-white/10 pt-6 space-y-3 text-white/80">
                                            {formData.adults > 0 && (
                                                <div className="flex justify-between">
                                                    ...
                                                    <span className="font-medium">£ {(formData.adults * 9.95).toFixed(2)}</span>
                                                </div>
                                            )}
                                            {formData.kids > 0 && (
                                                <div className="flex justify-between">
                                                    <span>Kids × {formData.kids}</span>
                                                    <span className="font-medium">£ {(formData.kids * 9.95).toFixed(2)}</span>
                                                </div>
                                            )}
                                            {formData.spectators > 0 && (
                                                <div className="flex justify-between">
                                                    <span>Spectators × {formData.spectators}</span>
                                                    <span className="font-medium">£ {(formData.spectators * 2.95).toFixed(2)}</span>
                                                </div>
                                            )}
